...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-pencil"></i>&nbsp; Billing Add</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group pull-right ">
                                    <button type="button" class="btn btn-success" id="btnAddRow"  onClick="addRow('billingTable')"><i class="fa fa-plus"></i>&nbsp;Row</button>
                                    <button type="button" class="btn btn-danger" id="btnDeleteRow" onClick="deleteRow('billingTable')" ><i class="fa fa-trash"></i>&nbsp;Row</button>
                                </div>
