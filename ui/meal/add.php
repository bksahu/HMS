...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; Add Meal</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i>&nbsp;Student Meals
                </div>
                <!-- /.panel-heading -->
                    ...
                    <form name="meal" action="add.php"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group ">
                                        <label>No Of Meal (as of today)</label>
