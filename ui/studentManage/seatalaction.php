        ...
        if ($msg = "true") {
            ...
            if(false===strpos((string)$result,"Can't"))
            {
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    array_push($data,$row['yearlyRent']);
                }
                // var_dump($data);
                formRender($data);
            }
...
{ ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-check-circle-o" aria-hidden="true"></i>&nbsp;Update Seat</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i>&nbsp;Update Student Seat Alocation
                </div>
                <!-- /.panel-heading -->
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" placeholder="Yearly Rent" class="form-control" name="yrent" value="<?php echo $data[2];?>" required>
                                                </div>
                                            </div>
                                        </div>
