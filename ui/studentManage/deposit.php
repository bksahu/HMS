    ...
    class PDF extends FPDF
    {
        function Header()
        {
            ...
            $this->Image('./../../dist/images/logo.png',10,6,30,20);
              $title="HOSTEL";
            $subtitle="Jyoti Vihar Burla - 768019";
            $this->Cell(80);
            // Arial bold 15
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-cutlery"></i>&nbsp; Mess Money Deposit</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-info-circle fa-fw"></i>&nbsp;Mess Money Deposit
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="col-lg-12">
                        <form name="apyment" action="deposit.php"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
                            <button type="submit" class="btn btn-info pull-right"  name="btnPrint" ><i class="fa fa-print"></i>&nbsp; Print List</button>
                        </form>
                        </div>
