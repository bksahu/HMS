        ...
        if ($msg = "true") {
            ...
            if(false===strpos((string)$result,"Can't"))
            {
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    array_push($data,$row['hostelName']);
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-pencil-square-o"></i>&nbsp; Update Student</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                            ...
                            <form name="student" action="studentedit.php?update=1" onsubmit="return checkForm(this);" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" placeholder="Mobile No" class="form-control" name="cellNo" value="<?php echo $data[2];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-mobile-phone"></i>&nbsp; </span>
                                                    <input type="number" placeholder="Mobile No" class="form-control" name="fatherCellNo" value="<?php echo $data[14];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-addon"><i class="fa fa-mobile-phone"></i>&nbsp; </span>
                                                    <input type="number" placeholder="Mobile No" class="form-control" name="motherCellNo" value="<?php echo $data[16];?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group ">
                                                <button type="submit" class="btn btn-success" name="btnUpdate" ><i class="fa  fa-check"></i>&nbsp;Update</button>
                                            </div>
