...
<?php include('./../../master.php'); ?>
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header titlehms"><i class="fa fa-pencil"></i>&nbsp; Admission</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                        ...
                        <form name="admission" action="admission.php" onsubmit="return checkForm(this);" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            <label>Student Id (Also Login Id)</label>
                                            <div class="input-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" placeholder="Mobile No" class="form-control" name="cellNo" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-key"></i>&nbsp; </span>
                                                <input type="password" id="rePassword" placeholder="confirm password" class="form-control" name="rePassword" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder="Name Of Institute" value="SUIIT" class="form-control" name="nameOfInst">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" placeholder="Year" class="form-control" name="batchNo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-info"></i>&nbsp; </span>
                                                <input type="text" placeholder="Nationality" class="form-control" name="nationality" value="Indian">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="hostelName">
                                                         <option value="MHR">Maytriee Hall of Residence</option>
                                                         <option value="AHR">Aryabhatta Hall of Residence</option>
                                                         <option value="BHR">Bhaskar Hall of Residence </option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i>&nbsp; </span>
                                                <input type="number" placeholder="Mobile No" class="form-control" name="fatherCellNo">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon"><i class="fa fa-mobile-phone"></i>&nbsp; </span>
                                                <input type="number" placeholder="Mobile No" class="form-control" name="motherCellNo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
