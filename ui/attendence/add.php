        ...
        if (isset($_POST["btnSave"])) {
            ...
            if ($msg = "true") {
                ...
                if(mysql_num_rows($result)<1) {
                    ...
                    // Fix this -> NOT taking new values if the previous value is given today. HINT: Check the msql query.    
                        ...
                        // Fix this -> Page breaking. Unable to select name.
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp; Add Attendence</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
