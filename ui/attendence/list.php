        ...
        if ($msg = "true") {
            ...
            if(false===strpos((string)$result,"Can't"))
            {
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    $GLOBALS['output'] .= "<td><a title='Edit' class='btn btn-success btn-circle editBtn' href='#".$row['serial']."'><i class='fa fa-pencil fa-align-center'></i></a>&nbsp;&nbsp;<a title='Delete' class='btn btn-danger btn-circle' href='list.php?id=" . $row['serial'] ."&wtd=delete'"."><i class='fa fa-trash'></i>&nbsp;</a></td>";
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header titlehms"><i class="fa fa-list"></i>&nbsp; Attendence List</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-pencil-square" aria-hidden="true"></i>&nbsp; Update Attendence
                </div>
                <!-- /.panel-heading -->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-list"></i>&nbsp; Student Attendence List
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php if($GLOBALS['isData']=="1"){echo $GLOBALS['output'];}
                             ...
                             {
                                 echo "<h1 class='text-danger text-center'>Attendance data not found, please try again.</h1>";
                             }
                            ?>
                        </div>
                    </div>
