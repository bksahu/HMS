...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            <img alt="HMS" class="pull-left" height="50" width="50" style="padding: 5px;margin-left: 5px" src="<?php echo $base_url.'dist/images/logonav.png'?>"><a class="navbar-brand titlehms" href="<?php echo $base_url.'sdashboard.php'?>">Hostel Management System</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li>
                        <a href="<?php echo $base_url.'ui/stdpayment/view.php'?>"><i class="fa fa-pencil-square-o fa-fw"></i>&nbsp; Payment view</a>
                        <a href="<?php echo $base_url.'ui/bill/view.php'?>"><i class="fa fa-credit-card fa-fw"></i>&nbsp; Bill view</a>
                    </li>
                    <li class="divider"></li>
